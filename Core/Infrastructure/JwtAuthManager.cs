...
namespace Core.Infrastructure
{
  ...
  public class JwtAuthManager : IJwtAuthManager
  {
    ...
    public JwtAuthManager(JwtTokenConfig jwtTokenConfig)
    {
      ...
      _secret = Encoding.ASCII.GetBytes("MTS, Devcookies işletmesinin bir ürünüdür.");
    }
    //---------------------------------------------------------------
    ...
    public JwtAuthResult GenerateTokens(string username, Claim[] claims, DateTime now)
    {
      ...
      //};
      //SecurityToken a;
      //var q = new JwtSecurityTokenHandler().ValidateToken(accessToken, validationParameters, out a);
      ...
      return new JwtAuthResult
      {
        ...
        TokenExpireDate = now.AddMinutes(_jwtTokenConfig.AccessTokenExpiration)
      };
    }
    //---------------------------------------------------------------
    ...
    public (ClaimsPrincipal, JwtSecurityToken) DecodeJwtToken(string token)
    {
      ...
      {
        return (null, new JwtSecurityToken());
